...
//           <tbody>
//             {cases.map((caseItem) => (
//               <tr key={caseItem.caseNumber} className="border-b hover:bg-gray-50">
//                 <td className="px-4 py-4 text-sm font-medium text-gray-900">{caseItem.caseName}</td>
//                 <td className="px-4 py-4 text-sm text-emerald-600 font-semibold">{caseItem.caseNumber}</td>
//                 <td className="px-4 py-4 text-sm text-gray-700">{caseItem.module}</td>
//                 <td className="px-4 py-4 text-sm text-gray-600">{caseItem.lastUpdated}</td>
...
//       <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 text-sm text-gray-600">
//         <p>Showing {cases.length} of {cases.length} cases</p>
//         <div className="flex items-center gap-2">
//           <button type="button" className="px-3 py-1 rounded border border-gray-200 text-gray-500 hover:bg-gray-50">Prev</button>
//           <button type="button" className="px-3 py-1 rounded border border-gray-200 text-gray-500 hover:bg-gray-50">1</button>
//           <button type="button" className="px-3 py-1 rounded border border-gray-200 text-gray-500 hover:bg-gray-50">2</button>
//           <button type="button" className="px-3 py-1 rounded border border-gray-200 text-gray-500 hover:bg-gray-50">3</button>
//           <button type="button" className="px-3 py-1 rounded border border-gray-200 text-gray-500 hover:bg-gray-50">Next</button>
//         </div>
//       </div>
//     </div>
//   </div>
